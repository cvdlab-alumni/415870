...
S = function (dims) {
 ...
 R = function (dims) {
  ...
  VIEW = DRAW
//===================================================================================================
//SCORRERE FINO ALL'ESERCIZIO 5. E' STATO RIPORTATO IL CODICE DEGLI ESERCIZI PRECEDENTI PER RIPORTARE NEL MODELLO building LE MODIFICHE SULLE SCALE

//EXERCISE 01

//PIANO TERRA
//definizione del pilastro circolare
var circPill = EXTRUDE([2.45])(DISK(0.125)(36));
var circPill_firstRow_0 = T([1])([0.125])(circPill);

//definizione del pilastro rettangolare
var squarePill = EXTRUDE([2.45])(CUBOID([0.25,0.25]));
squarePill = T([2])([-0.125])(squarePill);

//definizione blocchi di raccordo tra un piano e l'altro
...
//EXERCISE 03 e 04 (le finestre vanno sui muri)
//Muro ovest
...
west_groundfloor = COLOR([1,0.5,0])(west_groundfloor);
...
east_groundfloor = COLOR([1,0.5,0])(east_groundfloor);
...
north_groundfloor = COLOR([1,0.5,0])(north_groundfloor);
...
south_groundfloor = COLOR([1,0.5,0])(south_groundfloor);
...
building = S([1,2,3])([10,10,10])(building);
VIEW(building);  
//Roberto Manca 