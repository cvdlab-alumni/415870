...
#========================================================
# !!!!!		LE SUPERFICI SONO IN FONDO AL FILE 		!!!!!
#========================================================
...
vano_anteriore_piano_y_frontal_points_12 = [[1,0 +3,2],[6,distanza_tra_frontal_behind/2,2],[1,distanza_tra_frontal_behind -3 ,2]]
...
def cerchione (r1, r2, R1, R2, n_raggi, dy ,dz):
	...
	cerchioni = COLOR([51./256,51./256,51./256])(cerchioni)
	return cerchioni
...
domain2D = GRID([10,10])
controls = [vano_anteriore_piano_y_frontal_1,vano_anteriore_piano_y_frontal_12,vano_anteriore_piano_y_frontal_2]

spoiler_mapping = BEZIER(S2)(controls)
spoiler = COLOR([0,0,0])(MAP(spoiler_mapping)(domain2D))

vano_anteriore_piano_y_frontal_cofano_points_12 = [[8,0,7],[8,4,7],[8,4,7],[8,7,6],[8,16,6],[8,distanza_tra_frontal_behind-1,7],[8,distanza_tra_frontal_behind-1,7],[8,distanza_tra_frontal_behind,7]]
vano_anteriore_piano_y_frontal_cofano_12 = BEZIER(S1)(vano_anteriore_piano_y_frontal_cofano_points_12)

vano_anteriore_piano_y_frontal_cofano_points_21 = [[5,0,8],[5,7,2],[5,16,2],[5, distanza_tra_frontal_behind,8]]
vano_anteriore_piano_y_frontal_cofano_21 = BEZIER(S1)(vano_anteriore_piano_y_frontal_cofano_points_21)

controls = [vano_anteriore_piano_y_frontal_cofano_1, vano_anteriore_piano_y_frontal_cofano_12, vano_anteriore_piano_y_frontal_cofano_21, vano_anteriore_piano_y_frontal_2]
cofano_anteriore_mapping = BEZIER(S2)(controls)
cofano_anteriore = COLOR([221.0/256, 113.0/256, 0])(MAP(cofano_anteriore_mapping)(domain2D))

controls = [coda_posteriore_inferiore_frontal_piano_x_1, coda_posteriore_inferiore_behind_piano_x_1]
retrotreno_mapping = BEZIER(S2)(controls)
retrotreno = COLOR([221.0/256, 113.0/256, 0])(MAP(retrotreno_mapping)(domain2D))

parte_centrale_portiera_frontal_piano_x_points_12 = [[13.0,0,7],[12.5,0,4.5],[14.3,0,6.75],[14.5,0 ,2.5]]
parte_centrale_portiera_frontal_piano_x_12 = BEZIER(S1)(parte_centrale_portiera_frontal_piano_x_points_12)
parte_centrale_portiera_frontal_piano_x_points_22 = [[14.5,-1,6],[14.5,-1,3.5],[15.8,-1,6],[17,0 ,2.35]]
parte_centrale_portiera_frontal_piano_x_22 = BEZIER(S1)(parte_centrale_portiera_frontal_piano_x_points_22)
controls = [portiera_frontal_piano_x_1, parte_centrale_portiera_frontal_piano_x_12, parte_centrale_portiera_frontal_piano_x_22, parte_centrale_portiera_frontal_piano_x]
portiera_front_mapping = BEZIER(S2)(controls)
portiera_front = COLOR([221.0/256, 113.0/256, 0])(MAP(portiera_front_mapping)(domain2D))

parte_centrale_portiera_behind_piano_x_points_12 = [[13.0,distanza_tra_frontal_behind,7],[12.5,distanza_tra_frontal_behind,4.5],[14.3,distanza_tra_frontal_behind,6.75],[14.5,distanza_tra_frontal_behind ,2.5]]
parte_centrale_portiera_behind_piano_x_12 = BEZIER(S1)(parte_centrale_portiera_behind_piano_x_points_12)
parte_centrale_portiera_behind_piano_x_points_22 = [[14.5,distanza_tra_frontal_behind+1,6],[14.5,distanza_tra_frontal_behind+1,3.5],[15.8,distanza_tra_frontal_behind+1,6],[17,distanza_tra_frontal_behind ,2.35]]
parte_centrale_portiera_behind_piano_x_22 = BEZIER(S1)(parte_centrale_portiera_behind_piano_x_points_22)
controls = [portiera_behind_piano_x_1, parte_centrale_portiera_behind_piano_x_12, parte_centrale_portiera_behind_piano_x_22, parte_centrale_portiera_behind_piano_x]
portiera_behind_mapping = BEZIER(S2)(controls)
portiera_back = COLOR([221.0/256, 113.0/256, 0])(MAP(portiera_behind_mapping)(MAP([S2,S1])(GRID([10,10]))))


modello3D_x_y_Z = STRUCT([modello3D_x_y_Z, spoiler, cofano_anteriore, retrotreno, portiera_front, portiera_back])
