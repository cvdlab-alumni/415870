...
def raggi (n ,dy, dz, r2):
	...
	single_radius = STRUCT([POLYLINE(vertices),PROD([BEZIERSTRIPE([vertices,dy,22]),QUOTE([dy])])])
...
def esterno_volante():
  ...
  #esterno_volante = R([2,3])(PI/2)(esterno_volante)
  return esterno_volante

def volante ():
	volante = COLOR([0,0,0])(esterno_volante())
	punti_curva_superiore_volante_1 = [[-6,0,0], [-1,0,0], [-4,2,0], [0,2,0]]
	curva_superiore_volante_mapping_1 = BEZIER(S1)(punti_curva_superiore_volante_1)
	curva_superiore_volante_1 = OFFSET([1,1,1])(MAP(curva_superiore_volante_mapping_1)(domain1D))
	punti_curva_superiore_volante_2 = [[6,0,0], [1,0,0], [4,2,0], [0,2,0]]
	curva_superiore_volante_mapping_2 = BEZIER(S1)(punti_curva_superiore_volante_2)
	curva_superiore_volante_2 = OFFSET([1,1,1])(MAP(curva_superiore_volante_mapping_2)(domain1D))
	...
	punti_curva_superiore_volante_12 = [[-6,0,0], [-1,0,0], [-4,-2,0], [0,-2,0]]
	curva_superiore_volante_mapping_12 = BEZIER(S1)(punti_curva_superiore_volante_12)
	curva_superiore_volante_12 = OFFSET([1,1,1])(MAP(curva_superiore_volante_mapping_12)(domain1D))
	punti_curva_superiore_volante_22 = [[6,0,0], [1,0,0], [4,-2,0], [0,-2,0]]
	curva_superiore_volante_mapping_22 = BEZIER(S1)(punti_curva_superiore_volante_22)
	curva_superiore_volante_22 = OFFSET([1,1,1])(MAP(curva_superiore_volante_mapping_22)(domain1D))
	...
	punti_curva_inferiore_volante_1 = [[-6,0,0], [-1,0,0], [-4,-2,0], [0,-2,0], [0,-6,0]]
	...
	punti_curva_inferiore_volante_2 = [[6,0,0], [1,0,0], [4,-2,0], [0,-2,0], [0,-6,0]]
	...
	core = COLOR([221.0/256, 113.0/256, 0])(T([2,3])([0.6,-0.6])(MYEXTRUDE(1.2)(RING([0,2])([20,20]))))
	core_esterno = COLOR([0, 0, 0])(T([2,3])([0.6,-0.6])(MYEXTRUDE(1.2)(RING([2,2.6])([20,20]))))
	volante = (STRUCT([volante,curva_superiore_volante, core, curva_superiore_volante2,  curva_inferiore_volante, core_esterno]))
	return (volante)
...
steering = S([1,2,3])([0.2,0.2,0.2])(steering)
steering = T([1,2,3])([14,3,6])(steering)

wheel = STRUCT([ruota(3, 3.5,larghezza_wheel), cerchione(0.25,0.5, 2.5,3, 10, 0.2, larghezza_wheel)]);
