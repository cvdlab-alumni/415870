...
var square_map_side = 40;	//per effetti ottimali, min 40

var subsquare_side = 1;

var lake_depth = square_map_side*4/100;
...
function getSettlement(){
	...
	for (var n = 0; n<numb_settlement; n++) {
		...
		//COSTRUISCI STRADE
		var road1 = CUBOID([square_map_side/10 +1.5, 1.2])
		road1 = T([0,1,2])([2.5, 1.15/2, 2.05])(road1);
		road1 = COLOR(dark_grey)(road1);
		s.push(road1);

		var road2 = CUBOID([subsquare_side, 1.15*3])
		road2 = T([0,1,2])([square_map_side/10+2.5+1, -1.15/2, 2.05])(road2);
		road2 = COLOR(dark_grey)(road2);
		s.push(road2);

		var road3 = T([0])([-(square_map_side/10 +1.5)])(road2);
		road3 = COLOR(dark_grey)(road3);
		s.push(road3);

		var road4 = CUBOID([square_map_side/10 +2.45, 1]);
		road4 = T([0,1,2])([2.05, 2.15, 2.05])(road4);
		road4 = COLOR(dark_grey)(road4);
		s.push(road4);

		var road5 = CUBOID([square_map_side/10 +2.45, 1]);
		road5 = T([0,1,2])([2.05, -1.15, 2.05])(road5);
		road5 = COLOR(dark_grey)(road5);
		s.push(road5);
	}
	return s;
}
